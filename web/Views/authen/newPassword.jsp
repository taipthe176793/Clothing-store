        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-5">
                <div class="container bg-white rounded mt-2 mb-2 px-0">
                    ...
                    <div class="pt-3 pb-3">
                        <form class="form-horizontal" action="auth?action=newPassword" method="POST" name="newPasswordForm" onsubmit="return validateForm()">
...
<script>
    function validateForm() {
        ...
        let confPassword = form["confPassword"];
        let isValid = true;
